# -*- coding: utf-8 -*-
"""
Created on Sun Dec  1 16:44:00 2019
...
#path ="/home/moheet07/DR Diagnosis/"
file_repository = "C:/Users/Mohit/OneDrive/Documents/DR Diagnosis/"
path=file_repository
...
class kappa_metrics(Callback):
    ...
    def epoch_end(self, epoch, logs={}):
        ...
        if _val_kappa == max(self.val_kappas):
            ...
            self.model_resNet.save('model_res_DR.h5')
...
def build_model():
    ...
    model_resNet.add(layers.Dense(2, activation='sigmoid'))
...
model_resNet.load_weights('model_res_DR.h5')

y_pred = model_denseNet.predict(x_test) > 0.5
y_pred = y_pred.astype(int).sum(axis=1) - 1

test_df['diagnosis'] = y_pred
test_df.to_csv('submission_res.csv',index=False)

pred = pd.read_csv('submission_res.csv')
